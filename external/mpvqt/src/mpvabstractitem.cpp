...
QQuickFramebufferObject::Renderer *MpvAbstractItem::createRenderer() const
{
    if (QQuickWindow::graphicsApi() != QSGRendererInterface::OpenGL) {
        qWarning() << "The libmpv framebuffer renderer requires the OpenGL graphics API";
    }
...
void MpvAbstractItem::setNativeVideoOutput(bool enabled)
{
    d_ptr->m_nativeVideoOutput = enabled;
}

bool MpvAbstractItem::nativeVideoOutput() const
{
    return d_ptr->m_nativeVideoOutput;
}
