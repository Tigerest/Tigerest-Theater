...
{
    // Native gpu-next creates its own child window below the Qt host. In that
    // mode this QQuick item is only the input/visibility anchor and must not
    // create or drive a second libmpv render context.
