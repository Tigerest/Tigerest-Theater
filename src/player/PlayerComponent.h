...
public:
  ...
  Q_INVOKABLE bool userCommand(QString command);
  ...
  Q_INVOKABLE QVariantMap mpvDiagnostics();
...
private:
  ...
  void applyMediaAccessToken(const QString& token);
  ...
  QTimer m_audioOutputWarningTimer;
  bool m_audioOutputWarningShown = false;
