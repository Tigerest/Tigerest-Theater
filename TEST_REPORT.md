...
2.0.9-dev 已完成 Windows 实际编译、7 项 CTest、安装版和便携版打包，以及便携 ZIP 的全新目录解压一致性检查。本轮把双击暂停、原子加载、播放终止清理、WebEngine 合成和窗口/全屏恢复统一到同一套播放器会话生命周期中。
...
| 打包 | 2.0.9 安装器与便携 ZIP 生成成功；便携包全新目录解压和主程序哈希一致性通过。 |
