set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "Tigerest Theater - unofficial Emby client powered by libmpv")
set(CPACK_PACKAGE_VENDOR "Tigerest")
set(CPACK_PACKAGE_NAME "TigerestTheater")
...
set(CPACK_PACKAGE_FILE_NAME "TigerestTheater-${VERSION_STRING}-${CPACK_SYSTEM_NAME}")
set(CPACK_SOURCE_PACKAGE_FILE_NAME "TigerestTheater-${VERSION_STRING}-src")

set(CPACK_PACKAGE_INSTALL_DIRECTORY "Tigerest Theater")
...
if(WIN32)
  ...
  include(CPack)
  cpack_add_component(Core DISPLAY_NAME "Tigerest Theater" DESCRIPTION "Tigerest Theater (Core Application)" REQUIRED)
endif(WIN32)
